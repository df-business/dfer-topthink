...
use dfer\Phinx\Db\Adapter\AdapterFactory;
use dfer\Phinx\Db\Adapter\ProxyAdapter;
use dfer\Phinx\Migration\AbstractMigration;
use dfer\Phinx\Migration\MigrationInterface;
use dfer\Phinx\Util\Util;
...
class Migrate
{
    ...
    protected function getDbConfig(): array
    {
        ...
        if ($this->appName) {
            ...
            $table = 'plugin_' . dfer_parse_name($this->pluginName) . '_migration';
        } else {
            $table = 'migration';
        }
    ...
    public function getPath()
    {
        ...
        if ($this->appName) {
            ...
            $path = WEB_ROOT . 'plugins' . DIRECTORY_SEPARATOR . dfer_parse_name($this->pluginName) . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'migrations';
        } else {
            $path = $this->app->getRootPath() . 'vendor/dfer/topthink/src/data/migrations';
        }
