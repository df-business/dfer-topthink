...
namespace dfer\Phinx\Db\Adapter;
...
{
    /**
     * @var \dfer\Phinx\Db\Adapter\AdapterFactory|null
     */
     ...
     *
     * @return \dfer\Phinx\Db\Adapter\AdapterFactory
     */
     ...
     */
    protected $adapters = [
        'mysql' => 'dfer\Phinx\Db\Adapter\MysqlAdapter',
        'pgsql' => 'dfer\Phinx\Db\Adapter\PostgresAdapter',
        'sqlite' => 'dfer\Phinx\Db\Adapter\SQLiteAdapter',
        'sqlsrv' => 'dfer\Phinx\Db\Adapter\SqlServerAdapter',
    ];
     ...
     */
    protected $wrappers = [
        'prefix' => 'dfer\Phinx\Db\Adapter\TablePrefixAdapter',
        'proxy' => 'dfer\Phinx\Db\Adapter\ProxyAdapter',
        'timed' => 'dfer\Phinx\Db\Adapter\TimedOutputAdapter',
    ];
    ...
    {
        if (!is_subclass_of($class, 'dfer\Phinx\Db\Adapter\AdapterInterface')) {
            throw new RuntimeException(sprintf(
                'Adapter class "%s" must implement dfer\Phinx\\Db\\Adapter\\AdapterInterface',
                $class
            ));
        }
     ...
     * @return \dfer\Phinx\Db\Adapter\AdapterInterface
     */
    ...
    {
        if (!is_subclass_of($class, 'dfer\Phinx\Db\Adapter\WrapperInterface')) {
            throw new RuntimeException(sprintf(
                'Wrapper class "%s" must be implement dfer\Phinx\\Db\\Adapter\\WrapperInterface',
                $class
            ));
        }
     ...
     *
     * @param string $name Name
     * @param \dfer\Phinx\Db\Adapter\AdapterInterface $adapter Adapter
     * @return \dfer\Phinx\Db\Adapter\AdapterInterface
     */
