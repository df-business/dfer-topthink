...
//            exit; // finish preflight CORS requests here
        ...
        $strFileExtension = strtolower(dfer_get_file_extension($originalName));
...
//        $fileImage->setUploadInfo($arrInfo);
        ...
        //  $url=$first['url'];
        $storageSetting = dfer_get_dfer_settings('storage');
            ...
            if ($needUploadToRemoteStorage) {
                ...
                if (!empty($result)) {
                    return array_merge([
                        ...
                        'id'          => $strId,
                        'preview_url' => dfer_get_root() . '/upload/' . $arrInfo["file_path"],
                        'url'         => dfer_get_root() . '/upload/' . $arrInfo["file_path"],
                    ], $result);
                }
            } else {
