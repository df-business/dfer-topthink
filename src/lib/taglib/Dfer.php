    ...
    public function tagWidget($tag, $content)
    {
        ...
        if (empty($tag['name'])) {
            ...
            if (!empty($tag['tag'])) {
                ...
                if ($designingTheme) {
                    if (!isset($tag['class'])) {
                        $attrs[] = 'class="__dfer_widget_in_block"';
                    }

                    $attrs[] = 'data-dfer_theme_file_id="<?php echo $_theme_file_id;?>"';
                    $attrs[] = 'data-dfer_widget_id="<?php echo $_widget_id;?>"';
                }
                ...
                foreach ($tag as $attrName => $attrValue) {
                    ...
                    if ($attrName == 'class' && $designingTheme) {
                        $attrValue = '__dfer_widget_in_block ' . $attrValue;
                    }
